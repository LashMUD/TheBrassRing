...
int eventTickTock(int tick){
    ...
    //write("GetCurrentTime() is "+GetCurrentTime()+"\n");//added
...
string GetPhaseName(mixed val) {
    ...
    switch(val) {
        ...
        case 2: return "a waxing half moon";
        case 3: return "waxing gibbous";
        case 4: return "a full moon";
        case 5: return "waning gibbous";
        case 6: return "a waning half moon";
...
int GetPhase(string m) {
    ...
    //write("z is "+z+"\n");
    //write("y / z is "+y / z+"\n");
    //write("GetTime(time()+ticktock) is "+GetTime(time()+ticktock)+"\n");
    return y / z;
}
    ...
    switch(arg) {
            ...
            if( GetTimeOfDay() != "night" ) return "During the day?";
                ...
                while(i--) {
                    ...
                    if( (y = GetPhase(moons[i])) == 0 ) continue;
                        ...
                        "You gaze up at the sky, and see the moon...\n"+
        ...
        case "sky":
            if( GetTimeOfDay() == "night" ) {
                tmp =  GetLong("moon");
                if( !tmp ) {
                    return "\nThe sky is filled only with the glitter of stars.\n";
                }
                else {
                    return tmp;
                }
