...
void create(){
    ...
    SetLevel(40);
    SetNoSpells(0);
    SetShort("Henli Zigil the Devout");
    SetLong("Henli is short and stout with silver hair and soft brown eyes."); 
...
int eventHelp(object who, string unused){
    ::eventHelp(who);
    this_object()->eventForce("speak You may ADVANCE in level by asking me "+
        "'to advance'. Get some information by asking me about levels.");
    return 1;
}
