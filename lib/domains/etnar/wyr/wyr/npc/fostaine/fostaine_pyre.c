/* 
 * /domains/etnar/wyr/wyr/npc/fostaine_pyre.c.
 ...
 * this file works in conjunction with /domains/etnar/wyr/wyr/room/rm_174
...
int CheckEnv() {
    ...
    this_object()->GetInCombat() == 0 ) {
        ...
        this_object()->eventMove("/domains/etnar/wyr/wyr/room/rm_174");
...
int WieldLute() {
    if( present("lute",this_object()) && this_object()->GetInCombat() ){ 
        ...
        new("/domains/etnar/wyr/wyr/weap/fostaine_lute")->eventMove(this_object());
...
static void create() {
    ...
    SetWimpy(30);
    SetInventory( ([
        "/domains/etnar/wyr/wyr/npc/fostaine/fostaine_lute" : "-1",
        "/domains/etnar/wyr/wyr/npc/fostaine/fostaine_cloak" : "wear cloak",
    ] ));
    SetActionsMap( ([
        ( ( :CheckWielded(): ) ) : 100,
        ( ( :CheckEnv(): ) ) : 100,
