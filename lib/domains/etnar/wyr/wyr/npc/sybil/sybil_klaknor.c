...
static void create() {
    ...
    SetInventory( ([
        "/domains/etnar/wyr/wyr/npc/sybil/key_sybil_klaknor" : "1",
    ] ));
    SetActionsMap( ([
    ...
    SetTalkResponses( ([  
        ...
        "cabinet" : "I can't get into it! I've lost the key and can't retrieve my precious trinkets.",
        ({"doll", "cloth doll"}) : "That's Irwin's childhood doll. I don't like it!",
    ]) );
}
