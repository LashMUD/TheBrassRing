/* /domains/etnar/wyr/wyr/npc/smith_cd.c.
...
int WieldSword(){
    if(present("sword",this_object())){ 
        ...
        new("/domains/etnar/wyr/wyr/weap/caltan_sword")->eventMove(this_object());
...
static void create() {
    ...
    SetInventory( ([
        "/domains/etnar/wyr/wyr/npc/caltan/smithying_cape" : "wear cape",
        "/domains/etnar/wyr/wyr/npc/caltan/brass_ring" : "wear ring",
        "/domains/etnar/wyr/wyr/npc/caltan/caltan_sword" : "1",
    ] ));
    SetActionsMap( ([
        ( ( :CheckWielded(): ) ) : 100,
