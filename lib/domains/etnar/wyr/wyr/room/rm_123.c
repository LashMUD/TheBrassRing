...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/etnar/wyr/wyr/room/rm_108",
        "west" : "/domains/etnar/wyr/wyr/room/rm_116",
        "east" : "/domains/etnar/wyr/wyr/room/rm_209.c",
        ]) );
    SetDoor("north", "/domains/etnar/wyr/wyr/doors/108_123");
