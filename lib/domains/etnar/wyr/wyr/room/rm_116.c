...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/etnar/wyr/wyr/room/rm_115",
        "east" : "/domains/etnar/wyr/wyr/room/rm_123",
        "south" : "/domains/etnar/wyr/wyr/room/rm_195",
        "west" : "/domains/etnar/wyr/wyr/room/rm_130",
        ] ));
}
