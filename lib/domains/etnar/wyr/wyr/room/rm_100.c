...
static void create() {
    ...
    SetLong("   You are in a small semi-circular room. Pungent incense fills the air and "
            "is wafting about from two lit candles located on top of a small marble altar "
            "standing in the middle of the room. A sense of holiness pervades throughout. "
            "There are some curtains hanging on the east and west walls."
        );
    SetItems( ([
