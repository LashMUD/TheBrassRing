...
static void create() {
    ...
    SetExits( ([
         "west" : "/domains/etnar/wyr/wyr/room/rm_186",
         "east" : "/domains/etnar/wyr/wyr/room/rm_184",
         "northwest" : "/domains/etnar/wyr/wyr/room/rm_188",
         "southwest" : "/domains/etnar/wyr/wyr/room/rm_187",
         ] ));
}
