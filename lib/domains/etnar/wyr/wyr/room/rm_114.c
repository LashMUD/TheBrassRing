...
static void create() {
    ...
    SetClimate("outdoors");
    SetAmbientLight(30);
    SetShort("%^BOLD%^Village Hall%^RESET%^");
    SetLong("   To the east, you see the modest-sized Town Hall. A number of people are "
            "bustling to and fro through the door. A small house belonging to Sybil Klaknor "
            "is to the west. Northward, the road continues, and towards the northwest there "
            "appear to be stalls for pack horses and other animals.The road takes a "
            "slight bend eastwards to the south."
        );
    SetItems( ([ 
