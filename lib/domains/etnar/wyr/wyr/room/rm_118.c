...
static void create() {
    ...
    SetExits( ([
         "north" : "/domains/etnar/wyr/wyr/room/rm_106",
         "south" : "/domains/etnar/wyr/wyr/room/rm_121",
         "west" : "/domains/etnar/wyr/wyr/room/rm_157",
         "east" : "/domains/etnar/wyr/wyr/room/rm_170",
         ] ));
}
