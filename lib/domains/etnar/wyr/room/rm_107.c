...
static void create() {
    ...
    SetClimate("outdoors");
    SetAmbientLight(30);
    SetShort("%^BOLD%^By the Supply Shop%^RESET%^");
    ...
    SetExits( ([
                "north" : "/domains/etnar/wyr/wyr/room/rm_109",
                "east" : "/domains/etnar/wyr/wyr/room/rm_124",
                "south" : "/domains/etnar/wyr/wyr/room/rm_106",
        ] ));
}
