...
static void create() {
    ...
    SetExits( ([
        "west" : "/domains/etnar/wyr/wyr/room/rm_118", //through a door
        "east" : "/domains/etnar/wyr/wyr/room/rm_156"
    ] ));
}

mixed ReadPlacard(){
    return (mixed)this_player()->eventPage("/domains/etnar/wyr/wyr/text/vendorsign.txt");
}
