...
NEUTRAL-SEX MOB - Name : warg vicious [R-Number103], In room [3001] V-Number [6100]
Short description: the vicious warg
Title: None
Long description: A vicious warg is here, snarling angrily at you.
Monster Class: Normal   Level [5] Alignment[-350]
Birth : [1313903751]secs, Logon[1313903751]secs, Played[0]secs
