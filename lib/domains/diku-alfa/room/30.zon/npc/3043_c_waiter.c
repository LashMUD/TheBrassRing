...
static void create() {
    ...
    SetKeyName("the Cleric's Waiter");
    SetAdjectives( ({"waiter"}) );
    SetId( ({"waiter", "vendor"}) );
    SetShort("the Cleric's Waiter");
    SetLong("A waiter who seems to have reach contact with God.");
    SetInventory( ([
    ...
    SetStorageRoom("/domains/diku-alfa/room/30.zon/rm_3003_2");
    SetMaxItems(300);
...
MALE MOB - Name : waiter [R-Number23], In room [3001] V-Number [3043]
Short description: the Waiter
Title: None
Long description: A waiter who seems to have reach contact with God.
Monster Class: Normal   Level [23] Alignment[600]
Birth : [1317253649]secs, Logon [1317253649]secs, Played [0]secs
Age: [17] Years,  [0] Months,  [0] Days,  [0] Hours
Height [198]cm  Weight [200]pounds 
Hometown[0], Speaks[0/0/0], (STL[0]/per[19]/NSTL[0])
Str:[11/0]  Int:[11]  Wis:[11]  Dex:[11]  Con:[11]
Mana p.:[10/100+23]  Hit p.:[430/430+23]  Move p.:[50/50+23]
