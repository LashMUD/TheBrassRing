...
MALE MOB - Name : cityguard guard [R-Number34], In room [3001] V-Number [3067]
Short description: the Cityguard
Title: None
Long description: A cityguard is here, guarding the gate.
Monster Class: Normal   Level [10] Alignment[1000]
Birth : [1317254141]secs, Logon [1317254141]secs, Played [0]secs
Age: [17] Years,  [0] Months,  [0] Days,  [0] Hours
Height [198]cm  Weight [200]pounds 
Hometown[0], Speaks[0/0/0], (STL[0]/per[19]/NSTL[0])
Str:[11/0]  Int:[11]  Wis:[11]  Dex:[11]  Con:[11]
Mana p.:[20/100+10]  Hit p.:[128/128+10]  Move p.:[50/50+10]
AC:[20/10], Coins: [500], Exp: [9000], Hitroll: [10], Damroll: [3]
Position: Standing, Fighting: Nobody
Default position: Standing, NPC flags: SPEC SENTINEL ISNPC STAY-ZONE , Timer [0]
